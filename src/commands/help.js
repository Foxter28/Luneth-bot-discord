...
const COMMAND_INFO = [
    ...
    },
    {
        ...
        category: 'admin',
        emoji: '🎉',
        usage: 'giveaway create prize:<n> duration:<min> winners:<n>',
    ...
    },
    {
        ...
        category: 'shop',
        emoji: '🔄',
        usage: 'trade create/list/cancel',
        desc: 'Create trade listings to sell items to other players, view listings, or cancel.',
    },
];
